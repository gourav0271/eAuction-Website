def sendMail(email,password):
     ...
     html="""<html>
                         ...
                         <body>
                                   ...
                                   <br>
                                   <a href='http://localhost:8000/verify?vemail="""+email+"""'
                                   >Click here to verify account</a>
                                   </body>
                    </html>
               """
     s=smtplib.SMTP("smtp.gmail.com",587)
     s.starttls()
     s.login("bairagigourav544@gmail.com","fbqeioyyvblhmddv")
